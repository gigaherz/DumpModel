             ...
             OutputStreamWriter writer = new OutputStreamWriter(stream))
        {
            ...
            for (Direction dir : DIRECTIONS)
            {
                ...
                for (BakedQuad quad : model.getQuads(state, dir, rand, modelData))
                {
                    ...
                    List<Integer> indices0 = Lists.<Integer>newArrayList();
                    List<Integer> indices1 = Lists.<Integer>newArrayList();
                    List<Integer> indices2 = Lists.<Integer>newArrayList();
                    List<Integer> indices3 = Lists.<Integer>newArrayList();
